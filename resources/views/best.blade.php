...
<div class="container">
    <br>
    <div class="row">
        <h2 style="font-family: 'Dosis', sans-serif; text-align:center; width: 100%;"><b>Buku Best Seller</b></h2>
    </div>
    <br>
    <form action="/searchbest" method="GET">
            ...
            <tbody>
                @foreach ($table as $b)
                    <tr>
                        ...
                        <th>{{ $b->BAHASA}}</th>
                        <td>
                            <form action="/morebest/{{ $b->ID }}" method="GET">
